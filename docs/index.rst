...
The most common case is the installation by pip3::
   $ pip3 install qsketchmetric

Getting started with QSketchMetric
-------------------------------------
...
.. figure:: docs/_static/Media/mtext.png
...
.. figure:: docs/_static/Media/example2.png
...
5.
   ...
   * POINT
        ...
        For example  ``name: happy_point``. This variable will be returned by the renderer as a ``dict``::

                {
                    "happy_point": (x, y)
                }

.. figure:: docs/_static/Media/example3.png
